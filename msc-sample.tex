...
In this thesis, an alternative mechanism for organising network interactions in Kotlin was
developed. This mechanism uses approach uncommon for Kotlin, called Remote Procedure Call (RPC).
